...
<nav class="navbar navbar-expand-lg navbar-light p-3">
    <div class="container-fluid">
        <a class="navbar-brand" href=""> <img src='assets/tether1.png' height='80px' /> </a>
        ...
        <div class=" collapse navbar-collapse fs-4" id="navbarNavDropdown">
            ...
            <ul class="navbar-nav ms-auto  d-lg-inline-flex">
                <li class="nav-item mx-2 ms-auto">
                    <a class="nav-link  btn rounded-pill signBtn "  href="" target="blank">
                        <i class="fab fa-google-plus-square text-light">SignUp</i>
                    </a>
                </li>
                <li class="nav-item mx-2 ms-auto">
                    <a class="nav-link text-dark btn btn-lg" href="" target="blank">
